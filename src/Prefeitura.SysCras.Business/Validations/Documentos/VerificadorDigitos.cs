...
{
    public class VerificadorDigitos
    {
        ...
        private readonly bool _complementModule = true;

        public VerificadorDigitos(string number)
        {
            _number = number;
        }

        public VerificadorDigitos ComMultiplicadoresDeAte(int primeiroMultiplicador, int ultimoMultiplicador)
        {
            _multipliers.Clear();
        ...
        public VerificadorDigitos Substituindo(string substituto, params int[] digitos)
        {
